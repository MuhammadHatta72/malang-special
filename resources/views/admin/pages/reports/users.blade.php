...
<div class="px-4 pt-8 pb-3 sm:ml-64">
    <div class="mt-12 mr-3">
        ...
        <!-- End Error Message -->
        @endif
        <h2 class="text-2xl text-gray-800 dark:text-gray-100">Laporan Pengguna</h2>
        ...
        <div class="w-full mt-4 px-6 py-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="flex flex-col md:flex-row">
                <form action="/export-users-excel" method="post">
                    @csrf
                ...
                <form action="/export-users-pdf" method="post">
                    @csrf
