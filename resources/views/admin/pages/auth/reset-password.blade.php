             ...
             <div class="w-full bg-white rounded-lg shadow-xl dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                 <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                     ...
                     <form class="space-y-4 md:space-y-6" method="post" action="{{ route('password.update') }}">
                         ...
                         <button type="submit" class="w-full text-white bg-[#F7C04B] hover:bg-[#c1912a] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#F7C04B] dark:hover:bg-[#c1912a] dark:focus:ring-primary-800">Reset Password</button>
