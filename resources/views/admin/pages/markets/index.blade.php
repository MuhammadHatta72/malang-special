        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="flex justify-end px-4 pt-2">
                    <button id="dropdownButton-{{$market->id}}" data-dropdown-toggle="dropdown-{{$market->id}}" class="inline-block text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-1.5" type="button">
                    ...
                    <!-- Dropdown menu -->
                    <div id="dropdown-{{$market->id}}" class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                        <ul class="py-2" aria-labelledby="dropdownButton-{{$market->id}}">
                            <li>
                            ...
                            <form action="{{ url('markets/delete-image/'. $market->id) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <li>
                                    <button type="submit" class="block px-4 py-2 text-sm text-left w-full text-red-600 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white" onclick="return confirm('apakah yakin ingin mengahapus gambar toko?')">Delete Image</button>
                                </li>
                            </form>
                            @endif
                        </ul>
