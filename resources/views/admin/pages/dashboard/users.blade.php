        ...
        <div class="w-full mt-4 px-6 py-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="md:flex">
                ...
                <div class="flex flex-1 flex-col md:flex-row lg:flex-row md:gap-0 md:flex">
                    <div class="shadow-2xl bg-red-600 border-l-8 hover:bg-red-700 border-red-700 mb-2 p-2 md:w-1/3 md:mr-4 rounded-lg">
                    ...
                    <div class="shadow-lg bg-indigo-600 border-l-8 hover:bg-indigo-700 border-indigo-700 mb-2 p-2 md:w-1/3 md:mr-4 rounded-lg">
                        <div class="flex justify-between items-center">
                    ...
                    <div class="shadow-lg bg-yellow-400 border-l-8 hover:bg-yellow-500 border-yellow-500 mb-2 p-2 md:w-1/3 rounded-lg">
                        <div class="flex justify-between items-center">
