...
<div class="px-4 pt-8 pb-3 sm:ml-64">
    <div class="mt-12 mr-3">
        <h2 class="text-2xl text-gray-800 dark:text-gray-100">Keranjang</h2>

        <div class="w-full mt-4 px-6 py-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <h3 class="text-sm text-gray-600 dark:text-gray-200 mb-3">Daftar semua produk yang telah dimasukkan keranjang</h3>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td scope="row" class=" py-4">
                                <div class="flex justify-center items-center">
                                    <img src="{{ url('./images/image-3.png') }}" class="w-24 h-auto">
                                </div>
                            </td>
                            <td class="py-4 text-center">
                                Silver
            ...
            <a href="#" class=" text-white bg-[#549166] hover:bg-[#549166]/90 focus:ring-4 focus:outline-none focus:ring-[#549166]/50 font-medium rounded-lg text-sm px-5 py-2 text-center inline-flex items-center dark:focus:ring-[#549166]/55 mr-2 mb-2">
    ...
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="p-6 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah yakin ingin menghapus produk?</h3>
                <button data-modal-hide="popup-modal" type="button" class="text-white bg-[#F7C04B] hover:bg-[#F7C04B] focus:ring-4 focus:outline-none focus:ring-[#F7C04B] dark:focus:ring-[#F7C04B] font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                    Delete
                </button>
