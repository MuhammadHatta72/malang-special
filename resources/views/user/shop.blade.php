        ...
        <div class="container mx-auto py-9 md:py-12 lg:py-24">
          <div class="relative mx-4">
            ...
            <img
              ...
              alt="A work table with house plants"
              role="img"
              class="hidden sm:block lg:hidden w-full h-auto"
            />
            <img
              src="./images/malangKota.webp"
              alt="A work table with house plants"
            ...
            <div
              class="absolute z-10 top-0 right-0 mx-4 sm:mx-0 mt-36 sm:mt-0 sm:py-20 md:py-28 lg:py-20 xl:py-28 sm:pl-14 flex flex-col sm:justify-center items-center"
            >
