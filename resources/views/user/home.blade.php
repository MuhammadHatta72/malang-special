...
<nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
      <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
            <a href="#" class=" font-bold block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Home</a>
        </li>
        <li>
...
{{-- <section id="feature" class="my-24 max-w-screen-xl mx-auto grid grid-cols-12 gap-4">
    <div class="col-span-5">
        <img src="{{ url('./images/apple.jpeg') }}" alt="">
    </div>
    <div class="col-span-7">
        <h2 class="text-5xl font-semibold">Kampret</h2>

    </div> --}}
</section>
<section class="dark:bg-grey ">
    <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        ...
        <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            <h2 class="mb-4 text-7xl tracking-tight font-extrabold text-gray-900 dark:text-white">Popular Foods Today</h2>
...
<footer class="bg-white dark:bg-gray-900">
    ...
    <div class="mx-auto mt-10 w-full max-w-screen-xl p-4 py-6 lg:py-8">
