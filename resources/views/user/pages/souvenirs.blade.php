...
<section class="h-screen bg-cover bg-center bg-no-repeat bg-gray-100 bg-blend-multiply" style="background-image: url('./assets/images-home/slider2.png')">
    <div class="h-full flex flex-col items-center justify-center text-center px-5 md:px-0">
        ...
        <div class="flex justify-center">
            <a href="/#product-souvenir" class="inline-flex justify-center hover:text-gray-900 items-center p-3 text-base font-medium text-center text-white rounded-full border-2 border-white shadow-xl shadow-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400 animate-bounce">
