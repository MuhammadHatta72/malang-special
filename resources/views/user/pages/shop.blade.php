...
<section class="h-screen bg-cover bg-center bg-no-repeat bg-gray-100 bg-blend-multiply" style="background-image: url('./assets/images-home/slider2.png')">
    <div class="h-full flex flex-col items-center justify-center text-center px-5 md:px-0">
        ...
        <div class="flex justify-center">
            ...
            <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="inline-flex justify-center hover:text-gray-900 items-center p-3 text-base font-medium text-center text-white rounded-full border-2 border-white shadow-xl shadow-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400 animate-bounce">
            ...
            <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                ...
                <li>
                    <a href="#product-food" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Makanan</a>
                </li>
                <li>
                    <a href="#product-drink" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Minuman</a>
                </li>
                <li>
                    <a href="#product-shirt" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Baju</a>
                </li>
                <li>
                    <a href="#product-souvenir" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Souvenir</a>
                </li>
                </ul>
            </div>
...
<section id="product-food" class="w-full pt-20 pb-10 dark:bg-gray-800">
    <div class="container mx-auto flex flex-wrap">
        ...
        <div class="w-full px-6 flex flex-col">
            <div class="mt-5 grid grid-cols-2 gap-6 sm:grid-cols-4 sm:gap-4 lg:mt-8">
                @foreach($product_foods as $product)
                <!-- Article -->
        ...
        <div class="w-full flex flex-col justify-center items-center mt-5 md:mt-10">
            <a href="/foods" class="inline-flex justify-center hover:text-gray-900 items-center py-4 px-5 text-base font-medium text-center text-white rounded-full bg-[#404A7F] hover:bg-gray-100 focus:ring-4 focus:ring-gray-400 shadow-lg">
                Selengkapnya
            </a>
        </div>
    </div>
...
<section id="product-drink" class="w-full pt-20 pb-10 bg-[#f1f4ff] dark:bg-gray-800">
    <div class="container mx-auto flex flex-wrap">
        <div class="w-full flex flex-col justify-start px-6">
            <h2 class="mt-3 md:mt-0 mb-2 md:mb-4 text-4xl tracking-tight font-extrabold text-gray-800 dark:text-white">Produk Minuman</h2>
            <hr class="w-20 h-2 bg-[#549166] rounded-full mb-2 md:mb-4" />
            <p class="mb-2 md:mb-4">Daftar produk minuman dari malang special</p>
        </div>
        <div class="w-full px-6 flex flex-col">
            <div class="mt-5 grid grid-cols-2 gap-6 sm:grid-cols-4 sm:gap-4 lg:mt-8">
                @foreach($product_drinks as $product)
                <!-- Article -->
        ...
        <div class="w-full flex flex-col justify-center items-center mt-5 md:mt-10">
            <a href="/drinks" class="inline-flex justify-center hover:text-gray-900 items-center py-4 px-5 text-base font-medium text-center text-white rounded-full bg-[#404A7F] hover:bg-gray-100 focus:ring-4 focus:ring-gray-400 shadow-lg">
                Selengkapnya
            </a>
        </div>
    </div>
...
<section id="product-shirt" class="w-full pt-20 pb-10 dark:bg-gray-800">
    <div class="container mx-auto flex flex-wrap">
        <div class="w-full flex flex-col justify-start px-6">
            <h2 class="mt-3 md:mt-0 mb-2 md:mb-4 text-4xl tracking-tight font-extrabold text-gray-800 dark:text-white">Produk Baju</h2>
            <hr class="w-20 h-2 bg-[#549166] rounded-full mb-2 md:mb-4" />
            <p class="mb-2 md:mb-4">Daftar produk baju dari malang special</p>
        </div>
        <div class="w-full px-6 flex flex-col">
            <div class="mt-5 grid grid-cols-2 gap-6 sm:grid-cols-4 sm:gap-4 lg:mt-8">
        ...
        <div class="w-full flex flex-col justify-center items-center mt-5 md:mt-10">
            <a href="/shirts" class="inline-flex justify-center hover:text-gray-900 items-center py-4 px-5 text-base font-medium text-center text-white rounded-full bg-[#404A7F] hover:bg-gray-100 focus:ring-4 focus:ring-gray-400 shadow-lg">
                Selengkapnya
            </a>
        </div>
    </div>
...
<section id="product-souvenir" class="w-full pt-20 pb-10 bg-[#f1f4ff] dark:bg-gray-800">
    <div class="container mx-auto flex flex-wrap">
        <div class="w-full flex flex-col justify-start px-6">
            ...
            <hr class="w-20 h-2 bg-[#549166] rounded-full mb-2 md:mb-4" />
            <p class="mb-2 md:mb-4">Daftar produk souvenir dari malang special</p>
        </div>
        <div class="w-full px-6 flex flex-col">
            <div class="mt-5 grid grid-cols-2 gap-6 sm:grid-cols-4 sm:gap-4 lg:mt-8">
                @foreach($product_souvernirs as $product)
                <!-- Article -->
                <article class="relative flex flex-col overflow-hidden rounded-xl shadow-lg hover:shadow-xl hover:shadow-[#F7C04B] border bg-white dark:bg-gray-700">
                    <div class="aspect-square overflow-hidden">
                        <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="h-full w-full object-cover transition-all duration-300 group-hover:scale-125 text-[#F7C04B]">
        ...
        <div class="w-full flex flex-col justify-center items-center mt-5 md:mt-10">
            <a href="/souvenirs" class="inline-flex justify-center hover:text-gray-900 items-center py-4 px-5 text-base font-medium text-center text-white rounded-full bg-[#404A7F] hover:bg-gray-100 focus:ring-4 focus:ring-gray-400 shadow-lg">
                Selengkapnya
            </a>
        </div>
    </div>
